...
export default async function OfficePage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <div
      className={`relative min-h-screen md:h-screen w-full flex flex-col-reverse md:flex-row bg-[rgb(54,68,79)] text-white overflow-x-hidden md:overflow-hidden pt-[70px] md:pt-24 ${font1.className}`}
    >
      ...
      <div className="w-full md:w-[40%] flex flex-col p-8 md:p-12 lg:p-16 justify-center bg-[rgb(54,68,79)] md:overflow-hidden">
        ...
        <h1
          className={`${font2.className} text-4xl md:text-5xl xl:text-6xl mb-6 leading-[1.1] text-white font-normal`}
        >
          {t("title")}
        </h1>
