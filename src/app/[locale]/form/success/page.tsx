...
export default function SuccessPage() {
  return (
    <div
      className={`min-h-screen w-full flex flex-col items-center justify-center bg-[rgb(54,68,79)] text-white p-8 ${font1.className}`}
    >
      <div className="max-w-md text-center flex flex-col items-center space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-1000">
        ...
        <p className="text-white/60 text-sm leading-relaxed max-w-sm mb-12">
          Thank you for reaching out. We have received your project details and
...
// this is just how the success page looks
